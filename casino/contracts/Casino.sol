...
contract Casino {
  ...
  function Casino(uint256 _minimunBet) public {
    owner = msg.sender;
  ...
  function distributePrizes(uint256 numberWinner) public {
    address[100] memory winners; // We have to create a tempory in memory array with fixed size
