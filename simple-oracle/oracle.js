...
var OracleContract = require('./build/contracts/CMCOracle.sjon')
...
oracleContract.setProvider(web3.currentrovider)
...
web3.eth.getAccounts((err, accounts) => {
  ...
  .then((oracleInstance) => {
    // Watch event and respond to events
    ...
    .watch((err, event) => {
      ...
      fetch.fetchUrl('https://api.coinmarketcap.com/v1/global/', (err, m ,b) => {
        ...
        // Send data back contract on-blockchain
